...
export const Skillsvg = () => (
  <svg
    ...
    className="icon-code"
  >
    <rect width="18" height="18" x="3" y="3" fill="#69d5b1" rx="2"></rect>
    <path
      fill="#179a6f"
...
export const Availablesvg = () => (
  ...
  >
    <circle cx="12" cy="12" r="10" fill="#69d5b1"></circle>
    <path
      fill="#179a6f"
...
export const Aboutsvg = () => (
  ...
  >
    <path fill="#69d5b1" d="M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20z"></path>
    <path
      fill="#179a6f"
